...
#     generate_file(project_name, lib_path, "model/core/common_interfaces_template.jinja", "model/core/common_interfaces.dart")

# def generate_entity(project_name: str, lib_path: Path):
#     generate_file(project_name, lib_path, "model/core/entity_template.jinja", "model/core/entity.dart")

# def generate_errors(project_name: str, lib_path: Path):
#     generate_file(project_name, lib_path, "model/core/errors_template.jinja", "model/core/errors.dart")

# def generate_failures(project_name: str, lib_path: Path):
#     generate_file(project_name, lib_path, "model/core/failures_template.jinja", "model/core/failures.dart")

# def generate_value_objects(project_name: str, lib_path: Path):
#     generate_file(project_name, lib_path, "model/core/value_objects_template.jinja", "model/core/value_objects.dart")

# def generate_value_validators(project_name: str, lib_path: Path):
#     generate_file(project_name, lib_path, "model/core/value_validators_template.jinja", "model/core/value_validators.dart")

# def generate_i_auth_facade(project_name: str, lib_path: Path):
#     generate_file(project_name, lib_path, "model/auth/i_auth_facade_template.jinja", "model/auth/i_auth_facade.dart")

# def generate_user(project_name: str, lib_path: Path):
#     generate_file(project_name, lib_path, "model/auth/user_template.jinja", "model/auth/user.dart")

# def generate_auth_failure(project_name: str, lib_path: Path):
#     generate_file(project_name, lib_path, "model/auth/auth_failure_template.jinja", "model/auth/auth_failure.dart")

# def generate_value_objects_auth(project_name: str, lib_path: Path):
#     generate_file(project_name, lib_path, "model/auth/value_objects_template.jinja", "model/auth/value_objects.dart")