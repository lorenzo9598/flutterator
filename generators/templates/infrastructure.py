...
#     generate_file(project_name, lib_path, "infrastructure/auth/firebase_auth_facade_template.jinja", "infrastructure/auth/firebase_auth_facade.dart")

# def generate_firebase_user_mapper(project_name: str, lib_path: Path):
#     generate_file(project_name, lib_path, "infrastructure/auth/firebase_user_mapper_template.jinja", "infrastructure/auth/firebase_user_mapper.dart")

# def generate_firebase_injectable_module(project_name: str, lib_path: Path):
#     generate_file(project_name, lib_path, "infrastructure/core/firebase_injectable_module_template.jinja", "infrastructure/core/firebase_injectable_module.dart")

# def generate_firestore_helpers(project_name: str, lib_path: Path):
#     generate_file(project_name, lib_path, "infrastructure/core/firestore_helpers_template.jinja", "infrastructure/core/firestore_helpers.dart")