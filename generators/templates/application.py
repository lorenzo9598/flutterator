...
#     generate_file(project_name, lib_path, "application/auth/auth_bloc_template.jinja", "application/auth/auth_bloc.dart")

# def generate_auth_event(project_name: str, lib_path: Path):
#     generate_file(project_name, lib_path, "application/auth/auth_event_template.jinja", "application/auth/auth_event.dart")

# def generate_auth_state(project_name: str, lib_path: Path):
#     generate_file(project_name, lib_path, "application/auth/auth_state_template.jinja", "application/auth/auth_state.dart")

# def generate_sign_in_form_bloc(project_name: str, lib_path: Path):
#     generate_file(project_name, lib_path, "application/auth/sign_in_form/sign_in_form_bloc_template.jinja", "application/auth/sign_in_form/sign_in_form_bloc.dart")    

# def generate_sign_in_form_state(project_name: str, lib_path: Path):
#     generate_file(project_name, lib_path, "application/auth/sign_in_form/sign_in_form_state_template.jinja", "application/auth/sign_in_form/sign_in_form_state.dart")

# def generate_sign_in_form_event(project_name: str, lib_path: Path):
#     generate_file(project_name, lib_path, "application/auth/sign_in_form/sign_in_form_event_template.jinja", "application/auth/sign_in_form/sign_in_form_event.dart")