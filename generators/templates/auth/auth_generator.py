...
def generate_files(project_name: str, lib_path: Path):
    ...
    generate_user_profile(project_name, lib_path)
...
def generate_user_profile(project_name: str, lib_path: Path):
    ...
    # Model layer
    generate_file(project_name, lib_path, "user_profile/model/user_profile_template.jinja", "domain/user_profile/model/user_profile.dart")
    generate_file(project_name, lib_path, "user_profile/model/user_profile_failure_template.jinja", "domain/user_profile/model/user_profile_failure.dart")
    generate_file(project_name, lib_path, "user_profile/model/i_user_profile_repository_template.jinja", "domain/user_profile/model/i_user_profile_repository.dart")
    # Infrastructure layer
    generate_file(project_name, lib_path, "user_profile/infrastructure/user_profile_dto_template.jinja", "domain/user_profile/infrastructure/user_profile_dto.dart")
    generate_file(project_name, lib_path, "user_profile/infrastructure/user_profile_mapper_template.jinja", "domain/user_profile/infrastructure/user_profile_mapper.dart")
    generate_file(project_name, lib_path, "user_profile/infrastructure/user_profile_repository_template.jinja", "domain/user_profile/infrastructure/user_profile_repository.dart")
    generate_file(project_name, lib_path, "user_profile/infrastructure/user_profile_service_template.jinja", "domain/user_profile/infrastructure/user_profile_service.dart")
