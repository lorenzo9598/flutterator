...
void initEnvironment() {
  ...
  if (environment.toLowerCase() == "production") {
    ...
    // Default url point is the mockapi.io one
    // You can change it to your local or other environment url
    Constants.apiUrl = "https://68e525968e116898997e9210.mockapi.io/api/v1";
  }
}
