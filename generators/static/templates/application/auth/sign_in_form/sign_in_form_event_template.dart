...
abstract class SignInFormEvent with _$$SignInFormEvent {
  ...
  const factory SignInFormEvent.confirmPasswordChanged(String confirmPasswordStr) = ConfirmPasswordChanged;
  const factory SignInFormEvent.toggleSignInAction() = ToggleSignInAction;
